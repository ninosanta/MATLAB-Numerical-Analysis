...
whos % ans sarà 1x3 e occuperà 24B
...
v1+v2 
v1-v2
v1*v2 % darà errore per via dei numeri di righe e colonne:
...
% oppure
dot(v1,v2) % sempre prodotto scaare
...
v1=[1 0 4 5 -3];
v2=[-2 0 3];
% non li posso sommare né fare altre operazioni
...
v=linspace(1,10,4)' % colonna
                    % estremo sx intervallo, dx e n° sottintervalli uguali
